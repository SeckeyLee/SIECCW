...
import Beanhelp.*;
@WebServlet(name = "ZengdsRnServlet",urlPatterns = "/zengdsrun")

public class ZengdsRunServlet extends HttpServlet {

	/**
		 * Constructor of the object.
		 */
	public ZengdsRunServlet() {
		super();
	}
		...
		request.setCharacterEncoding("utf-8");
		   HttpSession session =  request.getSession() ;
					...
					if(matcher.matches() == false){
					 ...
					 String str19 = request.getParameter("type");

					 IndexHelp c = new IndexHelp();
						DataBase a = new DataBase();

                        a.update("insert into SIECCW.dbo.ds values"+"('"+str1+"','"+str19+"')");
