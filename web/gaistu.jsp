...
<jsp:useBean id="gaip1" type="Javabean.ChapBean" scope="request"/>
   <div class="main-wrap">
	<div class="side-nav">
		<div class="side-logo">
			<div class="logo">
	...
	<div class="content-wrap">
		...
		<section class="page-hd">
				...
				<div class="form-group-col-2">
					...
					<div class="form-cont">
						<input type="text"  class="form-control form-boxed" style="width:300px;" value="<jsp:getProperty property="school" name="gaip1"/>" name="school" id="school">
				...
				<div class="form-group-col-2">
					...
					<div class="form-cont">
						<input type="text"  class="form-control form-boxed" style="width:300px;" value="<jsp:getProperty property="classes" name="gaip1"/>" name="class" id="class">
