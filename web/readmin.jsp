   ...
   <div class="main-wrap">
	...
	<div class="content-wrap">
		...
		<section class="page-hd">
				...
				<form action="readmin" method="post" onsubmit="return check();" >
				<div class="form-group-col-2">
					<div class="form-label">姓名：</div>
					<div class="form-cont">
						<input type="text"  class="form-control form-boxed" value="<%=session.getAttribute("name") %>" name="name" id="name">
					</div>
				</div>
				<div class="form-group-col-2">
					<div class="form-label"  >手机号码：</div>
					<div class="form-cont">
						<input type="telephone"  class="form-control form-boxed" style="width:300px;" value="<%=session.getAttribute("phone") %>" name="phone" id="phone">
