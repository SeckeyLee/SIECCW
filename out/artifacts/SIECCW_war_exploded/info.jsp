...
<script src="js/public.js"></script>
  ...
  <body>
<jsp:useBean id="info123" type="Javabean.ChapBean" scope="request"/>
	...
	<div class="content-wrap">
		...
		<main class="main-cont content mCustomScrollbar">
			...
			<section class="page-hd">
					...
					<center><table border=0><tr><td style="height:50px;width:200px;">学号：<jsp:getProperty name="info123" property="num"/></td></tr>
				
			
			
					<tr><td style="height:50px;">姓名：<jsp:getProperty name="info123" property="name"/></td></tr>
					
				  
				  <tr><td style="height:50px;">学院：<jsp:getProperty name="info123" property="school"/></td></tr>
			
							
				
		
		<tr><td style="height:50px;">班级：<jsp:getProperty name="info123" property="classes"/></td></tr>
					
				
		
					<tr><td style="height:50px;">电话号码：<jsp:getProperty name="info123" property="phone"/></td></tr>
