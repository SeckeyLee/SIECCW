...
<html>
<head>
    <jsp:useBean id="zpzs1" type="Javabean.ZpzsBean" scope="request"/>
...
<div class="bottombg">
    <div class="bottom_box" >
        ...
        <ul style="color: blue">
            <jsp:getProperty name="zpzs1" property="result"/>

        </ul>
        <hr style="height:5px;border:none;border-top:2px ridge #333333;">
        <br>
        <form action="zpzs" style="float:left">
            <font color="#00f" face="幼圆" style="font-size:150%">第<jsp:getProperty property="x" name="zpzs1"/> 页,共<jsp:getProperty property="pall" name="zpzs1"/>页。跳转到第<input style="width:50px; height:22px;border:double blue "type="number" name="page"  min="1" max='<jsp:getProperty property="pall" name="zpzs1"/>' required>页</font>
            <input type="submit" value="提交" style="width:50px; height:22px;border: solid #00f;color:#fff;background:#00f ">
        </form>

        <%ZpzsBean Dia = (ZpzsBean) request.getAttribute("zpzs1"); %>
        <form action="zpzs" style="float:right; ">
