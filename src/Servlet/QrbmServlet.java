...
@WebServlet(name = "QrbmServlet" ,urlPatterns = "/qrbm")
public class QrbmServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String str = "update SIECCW.dbo.bm set bm_or ='已确认' where bm_id='"+id+"'";
        DataBase a = new DataBase();
        a.update(str);
        RequestDispatcher dispatcher = request.getRequestDispatcher("dsbm");
