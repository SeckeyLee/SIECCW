...
@WebServlet(name = "ShanwServlet",urlPatterns = "/shanw")
public class ShanwServlet extends HttpServlet {
...
a.update("delete from SIECCW.dbo.sjds where sjds_id ='"+str1+"'");
RequestDispatcher dispather	= request.getRequestDispatcher("chaw");
