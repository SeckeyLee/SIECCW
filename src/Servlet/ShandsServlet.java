...
@WebServlet(name = "ShandsServlet",urlPatterns = "/shands")
public class ShandsServlet extends HttpServlet {

	/**
		 * Constructor of the object.
		 */
	public ShandsServlet() {
		super();
	}
...
a.update("delete from SIECCW.dbo.ds where sd_id ='"+str1+"'");
RequestDispatcher dispather	= request.getRequestDispatcher("chadsinfo");
