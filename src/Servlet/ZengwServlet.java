...
@WebServlet(name = "ZengwServlet",urlPatterns = "/zengw")
public class ZengwServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(matcher.matches() == false){
		 ...
		 RequestDispatcher dispather	= request.getRequestDispatcher("zengw.jsp");
