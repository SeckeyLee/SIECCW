...
@WebServlet(name = "ZengdsServlet" ,urlPatterns = "/zengdsinfo")
public class ZengdsServlet extends HttpServlet {

	/**
		 * Constructor of the object.
		 */
	public ZengdsServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 RequestDispatcher dispather	= request.getRequestDispatcher("zengds.jsp");
		    dispather.forward(request,response );return;
	}
